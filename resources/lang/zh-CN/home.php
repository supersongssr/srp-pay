...
return [
    ...
    'referral_table_apply'            => '银行卡提现',
    'referral_table_coupon'           => '代金券提现',
    'referral_summary'                => '当前剩余可提取返利 :amount $（ 返利 :total 次），满 :money $可以申请生成代金券、银行卡提现。',
    'referral_summary1'               => '*选择银行卡提现按2:1提现 , 每笔打款手续费0.1$ , 汇率按照银行汇率结转，请确认收款人正确无误！',
    'referral_apply_title'            => '提现记录',
    'referral_apply_coupon'           => '代金券列表',
    ...
    'profile'                         => '个人设置',
    'logout'                          => '退出',
    'promote_link'                    => '通过您的推广链接注册并激活，你们双方都将获得 :traffic 流量奖励；当他们消费时，您将获得他们消费金额的 :referral_percent% 作为奖励；当他们邀请的好友消费时，您将获得:referral_percent2%作为奖励。',
    'promote_invite_code'             => '通过您的邀请码注册并激活，你们双方都将获得 :traffic 流量奖励；当他们消费时，您将获得他们消费金额的 :referral_percent% 作为奖励；当他们邀请的好友消费时，您将获得:referral_percent2%作为奖励。',
